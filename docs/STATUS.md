...
**Next up: Phase 10 — the midnight board.** A full visual direction change, and
a **reversal** of what this app has looked like since 1.4: the card-stock ground
...
**10.1 has landed**: the decision, the rulebook and the palette, solved rather
than picked. Read D22 before touching a colour.

**This is landing before draft night, which is a deliberate risk**, stated here
...
**In progress.** One visual direction change, sequenced as nine slices so the
app is shippable after each. The decision is
[ADR-0006](adr/ADR-0006-midnight-board.md) / blueprint **D22**; it supersedes
D17, D21 and ADR-0005.
